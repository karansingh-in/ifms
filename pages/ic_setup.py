...
class ICSetup(QMainWindow):
    ...
    def initUI(self):
        ...
        grid.addWidget(heading3, 8, 0, 1, 4)
        grid.addWidget(contact_name1, 9, 0)
        grid.addWidget(self.contact_name1_text, 9, 1)
        grid.addWidget(contact_name2, 10, 0)
        grid.addWidget(self.contact_name2_text, 10, 1)
        grid.addWidget(contact_name3, 11, 0)
        grid.addWidget(self.contact_name3_text, 11, 1)
        grid.addWidget(designation1label, 9, 2)
        grid.addWidget(self.designation1dropdown, 9, 3)
        grid.addWidget(designation2label, 10, 2)
        grid.addWidget(self.designation2dropdown, 10, 3)
        grid.addWidget(designation3label, 11, 2)
        grid.addWidget(self.designation3dropdown, 11, 3)
        grid.addWidget(phone1, 9, 4)
        grid.addWidget(self.phone1_text, 9, 5)
        grid.addWidget(phone2, 10, 4)
        grid.addWidget(self.phone2_text, 10, 5)
        grid.addWidget(phone3, 11, 4)
        grid.addWidget(self.phone3_text, 11, 5)
        grid.addWidget(email1, 9, 6)
        grid.addWidget(self.email1_text, 9, 7)
        grid.addWidget(email2, 10, 6)
        grid.addWidget(self.email2_text, 10, 7)
        grid.addWidget(email3, 11, 6)
        grid.addWidget(self.email3_text, 11, 7)
        grid.addWidget(submitbutton_ic, 12, 6)
        grid.addWidget(cancelbutton, 12, 7)
